            ...
            <div className="container-fluid mt-5">
              <div className="row">
                ...
                <div className="col-xl-5 col-lg-12 col-md-12 col-sm-12 justify-content-center text-justify">
                  ...
                  <p className="mt-4 ">FundMyFarm is a platform that connects smallholder farmers to lenders. We connect farmers with those
                  ...
                  How will you feel helping others grow while making earning at same time? Definitely good! That is why we are here</p>
                  <Link to="/">
             ...
             <br/>
               <p className="h2 mt-5 font-weight-bold text-white why">Why FundMyFarm ?</p>
                 <div className="row">
                 <div className="col-sm-12 col-md-4 pro">
                 <div className="card">
                     <div className="card-body">
                         <p className=" card-title h4 font-weight-bold mt-5">The Problem</p>
                         <p className="card-text text-justify"> Smallholder farmers don’t have
                         access to credit facility they need to fully cultivate
                         their land and flourish. Formal financial institutions are virtually
                         nonexistent. </p>
                         <br/>
                     </div>
                   </div>
                 ...
                 <div className="card">
                     <div className="card-body">
                         ...
                         <p className="card-text text-justify">To address credit availability, we came
                             up with a platform that connects
                             farmers looking for credit with farm lovers looking to lend thier resources to grow together with farmers.  </p>
                             <br/>
                     </div>
                   </div>
                 </div>
